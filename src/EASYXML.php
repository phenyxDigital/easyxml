...
class EASYXML {
     ...
     * In previous versions, a custom DOMElement::$uxml property is used to keep a reference to the EASYXML instance.
     *
     ...
     * @return self                Wrapped element as a EASYXML instance
